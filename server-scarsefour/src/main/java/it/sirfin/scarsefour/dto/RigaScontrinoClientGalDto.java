 ...
 * @author manue
 */
public class RigaScontrinoClientGalDto {
    ...
    public RigaScontrinoClientGalDto() {
    }
    
    

    public RigaScontrinoClientGalDto(Long idRiga, Long idScontrino, Long idProdotto, String descrizione, Double prezzo) {
        this.idRiga = idRiga;
